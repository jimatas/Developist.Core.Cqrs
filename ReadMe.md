...
Splits the application's use-case processing layer into components that fit into one of two categories: _commands_ or _queries_. This library also adds the closely linked but separate _events_ (aka notifications) to these two categories.
